    ...
    return (
        <footer className="py-16 bg-secondary">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-10 text-base md:text-lg">
                    {links.map((link, index) => (
                        <Link
                            key={index}
                            href={link.href}
                            className="text-white hover:text-muted block duration-150">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        ...
                        className="text-muted hover:text-accent block">
                        <svg
                            className="size-6"
                ...
                <span className="text-muted block text-center text-base"> © {2026} Sari Madu, Semua hak dilindungi undang-undang</span>
            </div>
        </footer>
    )
}